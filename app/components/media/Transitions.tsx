    ...
    <Card
      ...
      <CardContent className="p-3">
        <div className="space-y-2">
          {/* Thumbnail */}
          <div className="relative w-full h-16 bg-muted rounded-sm overflow-hidden">{renderTransitionEffect()}</div>

          {/* Title and description */}
          <div>
            <div className="flex items-center gap-1">
              <span className="text-sm font-medium text-primary">{transition.name}</span>
            </div>
            <p className="text-xs text-muted-foreground leading-tight">{transition.description}</p>
          </div>
        </div>
      </CardContent>
    </Card>
